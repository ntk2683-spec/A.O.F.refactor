using UnityEngine;
[CreateAssetMenu(fileName = "Radial Shot Action", menuName = "SkillData/Actions/RadialShot")]
public class RadialShotAction : SkillAction
{
    [SerializeField] private GameObject radialBullet;
    ...
    private void CastUltimate()
    {
        ...
        for (int i = 0; i < bulletCount; i++)
        {
            ...
            GameObject bullet = Instantiate(radialBullet, firePos.position, rot);
